...
import { eventListeners, checkKeys, computerPlayer, initGame, gameLoop, _mouseDragged, player1, player2, ball } from "./gameLogic";
  ...
  useEffect(() => {
    ...
    new p5(p => {
      ...
      p.draw = () => {
        ...
        p.rect(player1.racket.x, player1.racket.y, RACKET_WIDTH, RACKET_HEIGHT, 10);
        p.rect(player2.racket.x, player2.racket.y, RACKET_WIDTH, RACKET_HEIGHT, 10);
        p.stroke('white');
        p.strokeWeight(4);
